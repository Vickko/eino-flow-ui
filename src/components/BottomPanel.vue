...
<template>
  <div class="h-64 border-t border-border bg-card flex flex-col shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-20">
    <!-- Header / Toolbar -->
    <div class="h-10 border-b border-border flex items-center justify-between px-4 bg-muted/30">
