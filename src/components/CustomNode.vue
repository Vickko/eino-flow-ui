...
<template>
  <div
    ...
    :class="[
      selected ? 'border-primary shadow-[0_0_0_2px_rgba(99,102,241,0.2)]' : 'border-border hover:border-primary/50 hover:shadow-sm'
    ]"
  >
    <!-- Handles -->
    ...
    <div class="px-3 py-2 border-b border-border flex items-center justify-between bg-muted/30 rounded-t-lg">
      <div class="flex items-center gap-2">
        <span
          ...
          :class="statusColor"
        ></span>
        <span class="text-xs font-mono text-muted-foreground uppercase tracking-wider">{{ data.type }}</span>
      </div>
    ...
    <div class="p-3">
      ...
      <div v-if="data.graph_schema" class="mt-3 pt-2 border-t border-border flex items-center gap-1.5 text-[10px] text-amber-600 font-medium">
