  ...
  <Transition name="dialog-backdrop">
    ...
    >
      <Transition name="dialog-content">
        ...
        >
          <!-- 对话框头部 -->
          <div class="relative flex items-center justify-between px-6 py-5 border-b border-border/40 bg-gradient-to-br from-background/80 to-muted/30">
            <div>
              <h2 class="text-xl font-semibold text-foreground flex items-center gap-2">
                模型管理
                <span class="text-xs font-normal text-muted-foreground px-2 py-0.5 bg-muted/60 rounded-full">
            ...
            >
              <X :size="20" class="text-muted-foreground group-hover:text-foreground transition-colors" />
            </button>
          </div>
          ...
          <div ref="scrollContainerRef" class="flex-1 overflow-y-auto px-6 pb-4 custom-scrollbar">
                ...
                >
                  ...
                  <div class="relative flex items-center gap-3">
                    ...
                    <div class="relative shrink-0">
                      <div class="w-10 h-10 rounded-xl bg-background/80 border-[0.5px] border-border/40 shadow-sm overflow-hidden group-hover:scale-105 transition-all duration-200">
                        <img
                          :src="model.icon"
                          :alt="model.name"
                    ...
                    <!-- 操作按钮 -->
                    <div class="shrink-0 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                      <button
            ...
            <div ref="formContainerRef" class="mt-4">
              ...
              >
                ...
                >
                  <Plus :size="18" class="text-muted-foreground/70 group-hover:text-primary transition-colors shrink-0" />
                  <span class="text-sm font-medium text-muted-foreground group-hover:text-primary transition-colors whitespace-nowrap">
                    添加新模型
                  </span>
                </div>
                ...
                >
                  <div class="overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <!-- 右侧图标预览 -->
                      <div class="flex flex-col items-center justify-center gap-4 p-6 bg-muted/30 rounded-xl border-[0.5px] border-border/30">
          ...
          <!-- 对话框底部 -->
          <div class="flex items-center justify-between px-6 py-4 border-t border-border/40 bg-gradient-to-br from-muted/20 to-background/80 backdrop-blur-sm">
            <button
              @click="handleReset"
